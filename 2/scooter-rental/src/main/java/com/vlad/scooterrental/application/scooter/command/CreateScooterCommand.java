...
public record CreateScooterCommand(
    String code, String model, ScooterStatus status, int batteryLevel, BigDecimal pricePerMinute) {
  public static CreateScooterCommand of(
      String code, String model, String statusName, int batteryLevel, BigDecimal pricePerMinute) {
