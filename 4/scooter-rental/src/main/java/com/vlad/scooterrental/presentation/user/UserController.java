...
import com.vlad.scooterrental.application.user.query.GetCurrentUserQuery;
import com.vlad.scooterrental.application.user.query.GetCurrentUserQueryHandler;
import com.vlad.scooterrental.application.user.query.GetUserByIdQuery;
import com.vlad.scooterrental.application.user.query.GetUserByIdQueryHandler;
import com.vlad.scooterrental.application.user.query.ListUsersQuery;
