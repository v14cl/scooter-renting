...
class RentalFactoryTest {
  ...
  void shouldRejectOverlappingRental() {
    ...
    RentalFactory rentalFactory =
        new RentalFactory(
            clock, new FakeRentalRepository(true), new FakeScooterRepository(scooter));
  ...
  void shouldRejectUnknownScooter() {
    RentalFactory rentalFactory =
        new RentalFactory(clock, new FakeRentalRepository(false), new FakeScooterRepository(null));
