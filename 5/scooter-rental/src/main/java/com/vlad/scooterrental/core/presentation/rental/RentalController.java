package com.vlad.scooterrental.core.presentation.rental;

import com.vlad.scooterrental.core.application.rental.command.CreateRentalCommand;
import com.vlad.scooterrental.core.application.rental.command.CreateRentalCommandHandler;
import com.vlad.scooterrental.core.application.rental.command.DeleteRentalCommand;
import com.vlad.scooterrental.core.application.rental.command.DeleteRentalCommandHandler;
import com.vlad.scooterrental.core.application.rental.command.UpdateRentalCommand;
import com.vlad.scooterrental.core.application.rental.command.UpdateRentalCommandHandler;
import com.vlad.scooterrental.core.application.rental.query.GetRentalByIdQuery;
import com.vlad.scooterrental.core.application.rental.query.GetRentalByIdQueryHandler;
import com.vlad.scooterrental.core.application.rental.query.ListRentalsQuery;
...
import com.vlad.scooterrental.core.presentation.dto.RentalRequest;
