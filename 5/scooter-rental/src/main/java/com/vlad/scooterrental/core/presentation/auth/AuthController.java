package com.vlad.scooterrental.core.presentation.auth;

import com.vlad.scooterrental.core.application.auth.AuthResult;
import com.vlad.scooterrental.core.application.auth.LoginCommand;
...
import com.vlad.scooterrental.core.presentation.dto.LoginRequest;
import com.vlad.scooterrental.core.presentation.dto.RegisterRequest;
...
public class AuthController {
  ...
  public ResponseEntity<AuthResult> register(@Valid @RequestBody RegisterRequest request) {
    ...
    AuthResult result = loginCommandHandler.handle(new LoginCommand(request.email(), request.password()));
