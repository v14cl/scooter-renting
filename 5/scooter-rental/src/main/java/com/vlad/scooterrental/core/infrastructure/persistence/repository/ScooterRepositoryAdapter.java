...
import com.vlad.scooterrental.core.infrastructure.persistence.mapper.ScooterEntityMapper;
...
public class ScooterRepositoryAdapter implements ScooterRepository {
  ...
  public ScooterRepositoryAdapter(
      ScooterJpaRepository scooterJpaRepository, ScooterEntityMapper scooterEntityMapper) {
  ...
  public Scooter save(Scooter scooter) {
    return scooterEntityMapper.toDomain(
        scooterJpaRepository.save(scooterEntityMapper.toEntity(scooter)));
  }
