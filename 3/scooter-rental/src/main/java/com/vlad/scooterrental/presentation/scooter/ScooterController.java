...
public class ScooterController {
    ...
    public ResponseEntity<ScooterView> create(@Valid @RequestBody ScooterRequest request) {
        ScooterView createdScooter = createScooterCommandHandler.handle(
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ScooterView update(@PathVariable UUID scooterId, @Valid @RequestBody ScooterRequest request) {
