...
class UpdateRentalCommandHandlerTest {
    ...
    void shouldRejectUpdateForAnotherUsersRental() {
        ...
        UpdateRentalCommandHandler handler = new UpdateRentalCommandHandler(
                new RentalFactory(clock),
                new InMemoryRentalRepository(rental),
                new InMemoryScooterRepository(new Scooter(
                        scooterId,
                        "SCT-77",
                        "Ninebot",
        ...
        assertThrows(AccessDeniedException.class, () -> handler.handle(new UpdateRentalCommand(
