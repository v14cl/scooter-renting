...
abstract class IntegrationTestSupport {
    ...
    @Autowired
    protected RentalJpaRepository rentalJpaRepository;

    @Autowired
    protected ScooterJpaRepository scooterJpaRepository;
    ...
    protected Map<String, Object> rentalPayload(String scooterId, LocalDateTime startTime, LocalDateTime endTime) {
        return Map.of(
                "scooterId", scooterId,
